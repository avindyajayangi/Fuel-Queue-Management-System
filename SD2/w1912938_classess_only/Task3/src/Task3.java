...
//
///**
// SD2 Course Work Task 03 (Waiting Queue).
// Fuel Center Program.
// G. W. Avindya Jayangi.
// */
//
...
//    static int fuelQuantity = 6600;   // Basic number of fuel liters per day
//    private static int fuelPrice = 430;         // Basic price of fuel per liter
//    private static LinkedList<Passenger> WaitingQueue = new LinkedList<Passenger>();
//
//    public static void setName(int [] array) {
//
...
//
//        WaitingQueue j = new WaitingQueue(new Passenger("Janith", "Chanaka"));
//
//       Passenger passenger1 = new Passenger("Avindya", "Gayali");
//
//       FuelQueue fuelQueue1 = new FuelQueue();
//
...
//            x[5] = 71;
//
//            Passenger i = new Passenger("firstName", "secondName");
//
//            FuelQueue y = new FuelQueue();
//
//            int v[] = new int[5];
//
//            v[1] = 10;
...
//            }
//        } else {
//            System.out.println("Sorry! All the queues are full. Customer will be added to the waiting queue.");
//            Scanner in = new Scanner(System.in);
//            System.out.print("Enter customer's first name: ");
//            String firstName = in.next();
//            System.out.print("Enter customer's second name: ");
...
//            int noOfLiters = in.nextInt();
//
//            WaitingQueue.add(new Passenger(firstName, secondName, vehicleNumber, noOfLiters));
//            System.out.println("Passenger " + firstName + " " + secondName + " successfully added to the waiting queue.");
//        }
//    }
//
...
//                    Passenger passenger = WaitingQueue.getFirst();
//                    if (fuelQuantity >= passenger.getNoOfLitters()) {
//                        queues[queueNo - 1].addPassenger(passenger.getFirstName(), passenger.getSecondName(), passenger.getVehicleNumber(), passenger.getNoOfLitters());
//                        queues[queueNo - 1].setIncome(queues[queueNo - 1].getIncome() + (passenger.getNoOfLitters() * fuelPrice));
//                        fuelQuantity -= passenger.getNoOfLitters();
//                        System.out.println("Passenger " + passenger.getFirstName() + " successfully added to the " + queueNo);
//                        WaitingQueue.remove(0);
//                    } else {
//                        System.out.println("Insufficient fuel in the stock. Only " + fuelQuantity + " liters available. Failed to add the customer.");
//                    }
//                }
//            } else {
